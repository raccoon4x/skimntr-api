...
- `prices`: Минимальные цены на скипасс, инстукторов и т.д.
  ...
  - `skipass_weekend`: Ски-пасс в выходные (стоимость одного подъема в рублях)
  - `instructor`: Стоимость одного занятия с инструктором
- `tariffs`: Данные о стоимости
  - `tariff_name`: Название абонемента/тарифа
  - `amount`: Стоимость абонемента/тарифа
  - `weekday`: Тариф в будни
  - `weekend`: Тариф в выходные
